...
public class PlayerCreation extends BorderPane {
  ...
  private String alternatyLobbyIdText =
      "Wenn Sie eine private Lobby erstellen können "
          + "sie keine Lobby ID eingeben, da der Server "
          + "eine ID zuweisen wird. Um die Lobby mit Freunden"
          + " zu teilen erfahren Sie die Lobby ID sobald sie auf \"Starten\" drücken.";
  ...
  void getOnlinePlayerInformation(GameModeSelector gameModeSelector) {
    ...
    textFieldLobby.setPromptText("Maus hier halten für mehr Infos");
    ...
    CheckBox checkbox = new CheckBox("Auswählen, wenn Sie eine private Lobby erstellen wollen");
    ...
    tooltipCheckbox.setText(
        "Sie können eine private Lobby erstellen, um nicht irgendeiner"
            + " Öffentlichten beizutreten sondern um ihre Lobby ID z.B. "
            + "mit einem Freund zu teilen, damit Sie mit diesem gemeinsam spielen können.");
  ...
  private VBox getColorPickerPane(ColorPicker colorPicker) {
    ...
    Label label = new Label("Wählen Sie Ihre Spielsteinfarbe:");
  ...
  private VBox getGameFieldSizeSelection(ChoiceBox<String> choiceBox) {
    ...
    Label label = new Label("Wie groß soll das Spielfeld sein ?");
    label.setId("normal-text");
